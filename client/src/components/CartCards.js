...
import { SafeAreaView, StyleSheet, Dimensions, Image, View, Text, TouchableOpacity, Animated} from 'react-native';
            ...
            <SafeAreaView style={styles.card}>
                    ...
                    <SafeAreaView>
                        ...
                        <View style={{flexDirection: 'row'}}>
                            <Text style={styles.cardDescription}>{product.product_description}</Text>
                            <View style={{marginLeft: 5}}>
                                <Entypo name="chevron-right" size={20} color={colors.blue}/>
                            </View>
                        </View>
                        <Text style={{marginLeft: 70, marginTop: 10, fontSize: 30, fontWeight: 'bold'}}>{product.product_cost} p.</Text>
                    </SafeAreaView>
            </SafeAreaView>
     </Swipeable>
    )
